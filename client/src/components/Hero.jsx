...
const Hero = () => {
  return (
    <div className='flex flex-col items-start justify-center px-4 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")]
    ...
    <p className='max-w-130 text-sm md:text-base mt-2'>Unparalled luxury and comfort await at the world's most exclusive hotels and resorts. Start your journey today.</p>
