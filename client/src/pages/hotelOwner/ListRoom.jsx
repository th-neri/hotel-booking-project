...
const ListRoom = () => {
  ...
  return (
    <div>
      <Title title='Room Listings' subTtitle='View, edit, or manage all listed rooms. Keep the information up-to-date to provide the best experience for users.'
        align='left' font='outfit' />
      <p className='text-gray-500 mt-8'>All Rooms</p>

      <div className='w-full max-w-3xl text-left border border-gray-300 rounded-lg max-h-80 overflow-y-full mt-3'>
              ...
              <tr key={index}>
                ...
                <td className='py-3 px-4 text-red-500 text-center border-t border-gray-300'>
                  <label className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3'>
                    ...
                    <span className='absolute dot top-1 left-1 w-5 h-5 bg-white rounded-full transition-transform duration-300 ease-in-out peer-checked:translate-x-5'></span>
                  </label>
                </td>
              </tr>
            ))}
